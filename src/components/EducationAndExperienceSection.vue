  ...
  <section class="p-4 md:p-8">
    <div class="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-8">
      ...
      <div class="col-span-1 ">
        <h2 class="mb-4 font-brand-primary text-2xl font-extrabold tracking-tight text-stone-200 sm:text-3xl"
          style="text-shadow: rgba(0, 0, 0, 0.5) 10px 10px 10px, rgba(0, 0, 0, 0.4) 20px 20px 20px, rgba(0, 0, 0, 0.1) 30px 30px 30px;">
          <span class="font-brand-primary text-green-700">For</span>mação
        </h2>
        ...
        <ul>
          <li class="relative border-b border-l border-gray-700 py-4 pl-4 last:border-b-0">
            <div class=" absolute -left-2 top-3 flex items-center space-x-2 md:-left-4">
              ...
              <span class="text-xs font-medium text-gray-200">Centro Universitário do Distrito Federal - UDF</span>
            </div>
            ...
            <div class="prose prose-sm flex flex-col pt-10 prose-ul:list-none">
              ...
              <p class=" text-gray-300">Aprofundei meus
                ...
                sistemas complexos. Foi nesse ambiente que descobri minha paixão por desenvolver aplicações escaláveis,
                estudar a segurança por trás de sistemas e explorar algoritmos avançados.
              </p>
            </div>
          </li>
          ...
          <li class="relative border-b border-l border-gray-700 py-4 pl-4 last:border-b-0">
            ...
            <div class="prose prose-sm flex flex-col pt-10 prose-ul:list-none">
              ...
              <p class=" text-gray-300">Nessa nova etapa acadêmica, estou aprofundando meus conhecimentos em
                ...
                Além disso, a pós tem reforçado conceitos de gestão de projetos ágeis, boas práticas de documentação e
                melhoria contínua em times de desenvolvimento, o que tem sido essencial para minha atuação atual como
